...
Azure::Storage.config.management_certificate   = File.expand_path('test/fixtures/management_certificate.pem')
Azure::Storage.config.management_endpoint      = 'https://management.core.windows.net'
Azure::Storage.config.subscription_id          = 'subscription-id'
